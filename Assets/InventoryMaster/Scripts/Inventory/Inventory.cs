...
public class Inventory : MonoBehaviour
{
    ...
    public void closeInventory()
    {
		...
		GameObject.Find("FirstPersonCharacter").GetComponent<CrosshairGUI>().m_ShowCursor = false;
		GameObject.FindWithTag("Player").GetComponent<UnityStandardAssets.Characters.FirstPerson.FirstPersonController>().enabled = true;
		GameObject.Find("WeaponHolder").GetComponent<SimpleWeaponSway>().enabled = true;
		GameObject.Find("Crowbar").GetComponent<PlayRandomAnimationOnClick>().enabled = true;
		//GameObject.FindWithTag("Player").GetComponent<MouseLook>().lockCursor = true;
    }

    public void openInventory()
    {
		GameObject.Find("FirstPersonCharacter").GetComponent<CrosshairGUI>().m_ShowCursor = true;
		...
		GameObject.Find("WeaponHolder").GetComponent<SimpleWeaponSway>().enabled = false;
		GameObject.Find("Crowbar").GetComponent<PlayRandomAnimationOnClick>().enabled = false;
		//GameObject.FindWithTag("Player").GetComponent<MouseLook>().lockCursor = false;
		Cursor.lockState = CursorLockMode.None;
		Cursor.lockState = CursorLockMode.Confined;
		Cursor.visible = true;
		Debug.Log ("CursorVisible");
